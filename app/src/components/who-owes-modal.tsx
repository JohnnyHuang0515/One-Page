      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex flex-col">
            <h2 className="text-lg font-bold">目前誰欠誰</h2>
        ...
        {data === null ? (
          ...
          <>
            <div className="mt-4 flex flex-col gap-1">
              <p className="text-[12px] tracking-wide text-text-3">{data.my_net >= 0 ? "目前別人總共欠你" : "目前你總共欠別人"}</p>
                      ...
                      <span className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm">
                          {p.net > 0 ? (
                            ...
                            <>
                              你 還 <span className="font-medium">{p.display_name}</span>
                            </>
                          ) : (
                            <>你和 {p.display_name}</>
                          )}
